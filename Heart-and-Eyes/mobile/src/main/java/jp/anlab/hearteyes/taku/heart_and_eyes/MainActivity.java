...
//        wellnessArray = new ArrayList<Integer>();
    ...
    private void initialize() {
        ...
        prebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (graphTitleJudge > 0) {
                    viewFlipper.showPrevious();
                    graphTitleJudge--;
                    graphTitle();
                } else {
                    Toast.makeText(MainActivity.this, "no graph", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void graphTitle() {
        switch (graphTitleJudge) {
            case 0:
                graphTitleText.setText("心拍数");
                break;
            case 1:
                graphTitleText.setText("瞬きの回数");
                break;
        }
    }
